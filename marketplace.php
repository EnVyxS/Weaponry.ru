...
if ($result->num_rows > 0) {
	...
	echo '   
	<div class="gallery">
		<div class="name"><a href="Pesan.php?id_barang='.$row['id_barang'].'">'.$row['nama_barang'].'</a></div>
		...
		<div class ="row"><a href="Pesan.php?id_barang='.$row['id_barang'].'"><input type = "submit" name = "submit" value = "BUY"></div>
	</div>
